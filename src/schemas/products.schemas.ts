...
export const createProductBodySchema = Type.Object({
  ...
  price: Type.String({
    ...
    description: 'Decimal price represented as a string with up to two fraction digits.',
    examples: ['1099.99']
  }),
...
export const listProductsQuerySchema = Type.Object({
  ...
  search: Type.Optional(
    Type.String({
      minLength: 1,
      maxLength: 255,
      description: 'Case-insensitive substring match against product name or SKU.',
      examples: ['iphone']
    })
  )
}, {
...
export const productResponseSchema = Type.Object({
  ...
  description: Type.Union([
    Type.String({ examples: ['256GB graphite'] }),
    Type.Null()
  ], {
    description: 'Optional long-form product description.'
  }),
